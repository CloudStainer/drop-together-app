    ...
    15313: function (t, e, r) {
      ...
      function L(t, e, r, n, o) {
        return (
          (e = +e),
          (r >>>= 0),
          o || I(t, e, r, 4, 34028234663852886e22, -34028234663852886e22),
      ...
      function U(t, e, r, n, o) {
        return (
          (e = +e),
          (r >>>= 0),
          o || I(t, e, r, 8, 17976931348623157e292, -17976931348623157e292),
        ...
        (s.prototype.write = function (t, e, r, n) {
          ...
          for (;;)
            switch (n) {
              ...
              case "utf8":
              case "utf-8":
                return (i = e), (o = r), j(M(t, this.length - i), this, i, o);
              case "ascii":
              case "latin1":
              case "binary":
                return (
      ...
      function x(t, e) {
        if ("number" != typeof t)
          throw new _.ERR_INVALID_ARG_TYPE(e, "number", t);
      }
      function C(t, e, r) {
        if (Math.floor(t) !== t)
          throw (
            (x(t, r), new _.ERR_OUT_OF_RANGE(r || "offset", "an integer", t))
          );
      ...
      Object.defineProperty(o, "defaultMaxListeners", {
        ...
        (o.prototype.emit = function (t) {
          ...
          if ("function" == typeof u) n(u, this, e);
            ...
            for (var h = u.length, l = y(u, h), r = 0; r < h; ++r)
              n(l[r], this, e);
          return !0;
        }),
        ...
        (o.prototype.once = function (t, e) {
          return s(e), this.on(t, a(this, t, e)), this;
        }),
        (o.prototype.prependOnceListener = function (t, e) {
          return s(e), this.prependListener(t, a(this, t, e)), this;
        }),
          ...
          for (
            isNaN((e = Math.abs(e))) || e === 1 / 0
              ...
              : ((f = Math.floor(Math.log(e) / Math.LN2)),
                ...
                f + a >= 1 ? (e += p / u) : (e += p * Math.pow(2, 1 - a)),
                e * u >= 2 && (f++, (u /= 2)),
                f + a >= l
                  ? ((s = 0), (f = l))
                  : f + a >= 1
                  ? ((s = (e * u - 1) * Math.pow(2, i)), (f += a))
                  : ((s = e * Math.pow(2, a - 1) * Math.pow(2, i)), (f = 0)));
            i >= 8;
            t[r + c] = 255 & s, c += y, s /= 256, i -= 8
          );
          for (
            f = (f << i) | s, h += i;
            h > 0;
