    ...
    38301: function (t, e, r) {
      ...
      var U = Object.defineProperty,
        ...
        q = (t, e) => {
          ...
          if (D) for (var r of D(e)) F.call(e, r) && L(t, r, e[r]);
          return t;
        };
      let z = {
      ...
      async function th(t, e) {
        try {
          return (
            (await t.getItem(e)) || (K() ? localStorage.getItem(e) : void 0)
          );
        } catch (t) {
          console.error(t);
        }
      ...
      !(function () {
        ...
        _.versions.node
          ? (r = tc)
          : i && (r = self);
        var n = !r.JS_SHA3_NO_COMMON_JS && td.exports,
      ...
      let tm = !1,
        tg = !1,
        tv = { debug: 1, default: 2, info: 2, warning: 3, error: 4, off: 5 },
        tA = 2,
        ty = null,
        tb = (function () {
          try {
      ...
      class tM {
        ...
        _log(t, e) {
          ...
          null == tv[r] &&
            ...
            tA > tv[r] || console.log.apply(console, e);
        }
        debug(...t) {
          this._log(tM.levels.DEBUG, t);
        }
        info(...t) {
          this._log(tM.levels.INFO, t);
        }
        warn(...t) {
          this._log(tM.levels.WARNING, t);
        }
        makeError(t, e, r) {
          if (tg) return this.makeError("censored error", e, {});
          e || (e = tM.errors.UNKNOWN_ERROR), r || (r = {});
          let i = [];
        ...
        throwArgumentError(t, e, r) {
          return this.throwError(t, tM.errors.INVALID_ARGUMENT, {
            argument: e,
            value: r,
          });
        }
        ...
        checkNormalize(t) {
          tb &&
            this.throwError(
              ...
              { operation: "String.prototype.normalize", form: tb }
            );
        }
        checkSafeUint53(t, e) {
          "number" == typeof t &&
            ...
            (t < 0 || t >= 9007199254740991) &&
              this.throwError(e, tM.errors.NUMERIC_FAULT, {
        ...
        checkArgumentCount(t, e, r) {
          (r = r ? ": " + r : ""),
            t < e &&
              this.throwError(
                "missing argument" + r,
                tM.errors.MISSING_ARGUMENT,
                { count: t, expectedCount: e }
              ),
            t > e &&
              this.throwError(
                "too many arguments" + r,
                tM.errors.UNEXPECTED_ARGUMENT,
                { count: t, expectedCount: e }
              );
        }
        checkNew(t, e) {
          (t === Object || null == t) &&
            this.throwError("missing new", tM.errors.MISSING_NEW, {
              name: e.name,
            });
        }
        checkAbstract(t, e) {
        ...
        static globalLogger() {
          return ty || (ty = new tM("logger/5.7.0")), ty;
        }
        ...
        static setLogLevel(t) {
          let e = tv[t.toLowerCase()];
          if (null == e) {
            tM.globalLogger().warn("invalid log level - " + t);
            return;
          }
          tA = e;
        }
      ...
      (tM.errors = c), (tM.levels = l);
      let tE = new tM("bytes/5.7.0");
      function tS(t) {
      ...
      function tB(t) {
        ...
        if ("string" == typeof t || !tN(t.length) || t.length < 0) return !1;
        for (let e = 0; e < t.length; e++) {
          let r = t[e];
          if (!tN(r) || r < 0 || r >= 256) return !1;
        }
        return !0;
      }
      function tx(t, e) {
        if ((e || (e = {}), "number" == typeof t)) {
          ...
          return 0 === e.length && e.push(0), tI(new Uint8Array(e));
        }
        if (
          ...
          r.length % 2 &&
            ("left" === e.hexPad
              ...
              : "right" === e.hexPad
              ? (r += "0")
              : tE.throwArgumentError("hex data is odd-length", "value", t));
          let i = [];
          for (let t = 0; t < r.length; t += 2)
            i.push(parseInt(r.substring(t, t + 2), 16));
          return tI(new Uint8Array(i));
        }
        return tB(t)
          ? tI(new Uint8Array(t))
          : tE.throwArgumentError("invalid arrayify value", "value", t);
      }
      function tC(t, e) {
        return !(
          "string" != typeof t ||
      ...
      let t_ = "0123456789abcdef";
      function tO(t, e) {
        if ((e || (e = {}), "number" == typeof t)) {
          tE.checkSafeUint53(t, "invalid hexlify value");
          let e = "";
          for (; t; ) (e = t_[15 & t] + e), (t = Math.floor(t / 16));
        ...
        if (tB(t)) {
          ...
          for (let r = 0; r < t.length; r++) {
            let i = t[r];
            e += t_[(240 & i) >> 4] + t_[15 & i];
          }
          return e;
        }
        return tE.throwArgumentError("invalid hexlify value", "value", t);
      }
      function tR(t, e, r) {
        return (
          "string" != typeof t
            ? (t = tO(t))
            : (!tC(t) || t.length % 2) &&
              tE.throwArgumentError("invalid hexData", "value", t),
          (e = 2 + 2 * e),
      ...
      function tk(t, e) {
        for (
          "string" != typeof t
            ? (t = tO(t))
            : tC(t) || tE.throwArgumentError("invalid hex string", "value", t),
            t.length > 2 * e + 2 &&
      ...
      function tP(t) {
        ...
        if ((tC(t) && !(t.length % 2)) || tB(t)) {
          let r = tx(t);
          64 === r.length
            ? ((e.v = 27 + (r[32] >> 7)),
              (r[32] &= 127),
              (e.r = tO(r.slice(0, 32))),
              (e.s = tO(r.slice(32, 64))))
            : 65 === r.length
            ? ((e.r = tO(r.slice(0, 32))),
              (e.s = tO(r.slice(32, 64))),
              (e.v = r[64]))
            : tE.throwArgumentError("invalid signature string", "signature", t),
            e.v < 27 &&
              (0 === e.v || 1 === e.v
                ? (e.v += 27)
                : tE.throwArgumentError(
          ...
          if (
            ...
            let r = (function (t, e) {
              ...
              return r.set(t, e - t.length), tI(r);
            })(tx(e._vs), 32);
            e._vs = tO(r);
            let i = r[0] >= 128 ? 1 : 0;
          ...
          let r = tx(e.s);
          r[0] >= 128 &&
            tE.throwArgumentError("signature s out of range", "signature", t),
            e.recoveryParam && (r[0] |= 128);
          let i = tO(r);
          e._vs &&
            (tC(e._vs) ||
              tE.throwArgumentError("signature invalid _vs", "signature", t),
            (e._vs = tk(e._vs, 32))),
            null == e._vs
              ? (e._vs = i)
              : e._vs !== i &&
      ...
      class tK {
        ...
        fromTwos(t) {
          return tJ(tG(this).fromTwos(t));
        }
        toTwos(t) {
          return tJ(tG(this).toTwos(t));
        }
        abs() {
          return "-" === this._hex[0] ? tK.from(this._hex.substring(1)) : this;
        }
        add(t) {
          return tJ(tG(this).add(tG(t)));
        }
        sub(t) {
          return tJ(tG(this).sub(tG(t)));
        }
        div(t) {
          return (
            tK.from(t).isZero() && tY("division-by-zero", "div"),
            tJ(tG(this).div(tG(t)))
          );
        }
        mul(t) {
          return tJ(tG(this).mul(tG(t)));
        }
        mod(t) {
          let e = tG(t);
          return (
            e.isNeg() && tY("division-by-zero", "mod"), tJ(tG(this).umod(e))
          );
        }
        pow(t) {
          let e = tG(t);
          return e.isNeg() && tY("negative-power", "pow"), tJ(tG(this).pow(e));
        }
        and(t) {
          let e = tG(t);
          return (
            (this.isNegative() || e.isNeg()) &&
              tY("unbound-bitwise-result", "and"),
            tJ(tG(this).and(e))
          );
        }
        or(t) {
        ...
        xor(t) {
          ...
          return (
            (this.isNegative() || e.isNeg()) &&
              tY("unbound-bitwise-result", "xor"),
            tJ(tG(this).xor(e))
          );
        }
        mask(t) {
          return (
            (this.isNegative() || t < 0) && tY("negative-width", "mask"),
            tJ(tG(this).maskn(t))
          );
        }
        shl(t) {
          return (
            (this.isNegative() || t < 0) && tY("negative-width", "shl"),
            tJ(tG(this).shln(t))
          );
        }
        shr(t) {
          return (
            (this.isNegative() || t < 0) && tY("negative-width", "shr"),
            tJ(tG(this).shrn(t))
          );
        }
        eq(t) {
          return tG(this).eq(tG(t));
        }
        lt(t) {
          return tG(this).lt(tG(t));
        }
        lte(t) {
          return tG(this).lte(tG(t));
        }
        gt(t) {
          return tG(this).gt(tG(t));
        }
        gte(t) {
          return tG(this).gte(tG(t));
        }
        isNegative() {
          return "-" === this._hex[0];
        }
        ...
        static from(t) {
          ...
          if ("string" == typeof t)
            return t.match(/^-?0x[0-9a-f]+$/i)
              ? new tK(tj, tQ(t))
              : t.match(/^-?[0-9]+$/)
              ? new tK(tj, tQ(new tq(t)))
              : tz.throwArgumentError("invalid BigNumber string", "value", t);
          if ("number" == typeof t)
            return (
              t % 1 && tY("underflow", "BigNumber.from", t),
              (t >= 9007199254740991 || t <= -9007199254740991) &&
                tY("overflow", "BigNumber.from", t),
              tK.from(String(t))
            );
          if ("bigint" == typeof t) return tK.from(t.toString());
          if (tB(t)) return tK.from(tO(t));
          if (t) {
            if (t.toHexString) {
              let e = t.toHexString();
              if ("string" == typeof e) return tK.from(e);
            } else {
              let e = t._hex;
              if (
                (null == e && "BigNumber" === t.type && (e = t.hex),
                "string" == typeof e &&
                  (tC(e) || ("-" === e[0] && tC(e.substring(1)))))
              )
                return tK.from(e);
            }
          }
          return tz.throwArgumentError("invalid BigNumber value", "value", t);
        }
      ...
      function tQ(t) {
        if ("string" != typeof t) return tQ(t.toString(16));
        if ("-" === t[0])
          return (
            "-" === (t = t.substring(1))[0] &&
              tz.throwArgumentError("invalid hex", "value", t),
            "0x00" === (t = tQ(t)) ? t : "-" + t
          );
      ...
      function tG(t) {
        let e = tK.from(t).toHexString();
        return "-" === e[0]
          ? new tq("-" + e.substring(3), 16)
          : new tq(e.substring(2), 16);
      }
      function tY(t, e, r) {
        let i = { fault: t, operation: e };
        return (
          null != r && (i.value = r),
          tz.throwError(t, tM.errors.NUMERIC_FAULT, i)
        );
      }
      let tV = new tM(tL),
        tW = {},
      ...
      function t$(t, e, r, i) {
        ...
        return (
          void 0 !== i && (n.value = i),
          tV.throwError(t, tM.errors.NUMERIC_FAULT, n)
        );
      }
      let t0 = "0";
      for (; t0.length < 256; ) t0 += t0;
      function t1(t) {
        if ("number" != typeof t)
          try {
            t = tK.from(t).toNumber();
          } catch {}
        return "number" == typeof t && t >= 0 && t <= 256 && !(t % 1)
          ? "1" + t0.substring(0, t)
          : tV.throwArgumentError("invalid decimal size", "decimals", t);
      }
      function t2(t, e) {
        null == e && (e = 0);
        let r = t1(e),
      ...
      function t3(t, e) {
        ...
        ("string" == typeof t && t.match(/^-?[0-9.]+$/)) ||
          tV.throwArgumentError("invalid decimal value", "value", t);
        let i = "-" === t.substring(0, 1);
        i && (t = t.substring(1)),
          "." === t && tV.throwArgumentError("missing value", "value", t);
        let n = t.split(".");
        n.length > 2 &&
          tV.throwArgumentError("too many decimal points", "value", t);
        let o = n[0],
          s = n[1];
          ...
          if ("string" == typeof t) {
            if ("fixed" !== t) {
              if ("ufixed" === t) e = !1;
                ...
                n || tV.throwArgumentError("invalid fixed format", "format", t),
                  (e = "u" !== n[1]),
                  (r = parseInt(n[2])),
                  (i = parseInt(n[3]));
              }
      ...
      class t8 {
        ...
        addUnsafe(t) {
          this._checkFormat(t);
          let e = t3(this._value, this.format.decimals),
            r = t3(t._value, t.format.decimals);
          return t8.fromValue(e.add(r), this.format.decimals, this.format);
        }
        subUnsafe(t) {
          this._checkFormat(t);
          let e = t3(this._value, this.format.decimals),
            r = t3(t._value, t.format.decimals);
          return t8.fromValue(e.sub(r), this.format.decimals, this.format);
        }
        mulUnsafe(t) {
          this._checkFormat(t);
          let e = t3(this._value, this.format.decimals),
        ...
        floor() {
          ...
          1 === t.length && t.push("0");
          let e = t8.from(t[0], this.format),
            r = !t[1].match(/^(0*)$/);
          return (
            this.isNegative() && r && (e = e.subUnsafe(t4.toFormat(e.format))),
            e
          );
        }
        ceiling() {
          ...
          let e = t8.from(t[0], this.format),
            r = !t[1].match(/^(0*)$/);
          return (
            !this.isNegative() && r && (e = e.addUnsafe(t4.toFormat(e.format))),
            e
          );
        }
        round(t) {
          ...
          if (
            (1 === e.length && e.push("0"),
            (t < 0 || t > 80 || t % 1) &&
              tV.throwArgumentError("invalid decimal count", "decimals", t),
            e[1].length <= t)
          )
            return this;
          let r = t8.from("1" + t0.substring(0, t), this.format),
            i = t5.toFormat(this.format);
        ...
        toHexString(t) {
          return null == t
            ? this._hex
            : (t % 8 && tV.throwArgumentError("invalid byte width", "width", t),
              tk(
                tK
                  .from(this._hex)
        ...
        toFormat(t) {
          return t8.fromString(this._value, t);
        }
        static fromValue(t, e, r) {
          ...
          return (
            ...
            null == e && (e = 0),
            null == r && (r = "fixed"),
            t8.fromString(t2(t, e), t6.from(r))
          );
        }
        static fromString(t, e) {
          ...
          !r.signed &&
            i.lt(tX) &&
            t$("unsigned value cannot be negative", "overflow", "value", t);
          let n = null;
          return new t8(
            tW,
            r.signed
              ? i.toTwos(r.width).toHexString()
              : tk(i.toHexString(), r.width / 8),
            t2(i, r.decimals),
            r
          );
        }
        ...
        static from(t, e) {
          if ("string" == typeof t) return t8.fromString(t, e);
          if (tB(t)) return t8.fromBytes(t, e);
          try {
            return t8.fromValue(t, 0, e);
          } catch (t) {
            if (t.code !== tM.errors.INVALID_ARGUMENT) throw t;
          }
          return tV.throwArgumentError("invalid FixedNumber value", "value", t);
        }
      ...
      let t4 = t8.from(1),
        t5 = t8.from("0.5"),
        t7 = new tM("strings/5.7.0");
      function t9(t, e, r, i, n) {
      ...
      function et(t, e = d.current) {
        e != d.current && (t7.checkNormalize(), (t = t.normalize(e)));
        let r = [];
        for (let e = 0; e < t.length; e++) {
      ...
      es(ef),
        ...
        (function (t) {
          ...
          for (;;) {
            let r = t() - 1;
            if (r < 0) break;
            e.push(eu(1 + t(), 1 + r, t).map((t) => [t[0], t.slice(1)]));
          }
          (function (t) {
            let e = {};
            for (let r = 0; r < t.length; r++) {
      ...
      let eh = `Ethereum Signed Message:
`;
      function ea(t) {
        return (
          "string" == typeof t && (t = et(t)),
          tU(
            (function (t) {
              let e = t.map((t) => tx(t)),
                r = e.reduce((t, e) => t + e.length, 0),
                i = new Uint8Array(r);
              return e.reduce((t, e) => (i.set(e, t), t + e.length), 0), tI(i);
            })([et(eh), et(String(t.length)), t])
          )
        );
      }
      new tM("rlp/5.7.0");
      let el = new tM("address/5.7.0");
      function ec(t) {
        tC(t, 20) || el.throwArgumentError("invalid address", "address", t);
      ...
      let ed = {};
      for (let t = 0; t < 10; t++) ed[String(t)] = String(t);
      for (let t = 0; t < 26; t++)
        ed[String.fromCharCode(65 + t)] = String(10 + t);
      let ep = Math.floor(
        Math.log10
      ...
      tK.from(
        ...
        tk(ev.toHexString(), 32),
        tk(eg.toHexString(), 32);
      var eA = {},
        ey = {};
      function eb(t, e) {
        if (!t) throw Error(e || "Assertion failed");
      }
      eb.equal = function (t, e, r) {
        if (t != e) throw Error(r || "Assertion failed: " + t + " != " + e);
      };
      var ew = { exports: {} };
      "function" == typeof Object.create
        ? (ew.exports = function (t, e) {
            e &&
              ((t.super_ = e),
      ...
      (ey.inherits = eM),
        ...
        (ey.toHex = function (t) {
          for (var e = "", r = 0; r < t.length; r++) e += eS(t[r].toString(16));
          return e;
        }),
        (ey.htonl = eE),
        (ey.toHex32 = function (t, e) {
          for (var r = "", i = 0; i < t.length; i++) {
            var n = t[i];
            "little" === e && (n = eE(n)), (r += eI(n.toString(16)));
          }
          return r;
        }),
        (ey.zero2 = eS),
        (ey.zero8 = eI),
        (ey.join32 = function (t, e, r, i) {
          var n,
            o = r - e;
          eb(o % 4 == 0);
        ...
        (ey.rotr32 = function (t, e) {
          return (t >>> e) | (t << (32 - e));
        }),
        (ey.rotl32 = function (t, e) {
          return (t << e) | (t >>> (32 - e));
        }),
        (ey.sum32 = function (t, e) {
          return (t + e) >>> 0;
        }),
        (ey.sum32_3 = function (t, e, r) {
          return (t + e + r) >>> 0;
        }),
        (ey.sum32_4 = function (t, e, r, i) {
          return (t + e + r + i) >>> 0;
        }),
        (ey.sum32_5 = function (t, e, r, i, n) {
          return (t + e + r + i + n) >>> 0;
        }),
        (ey.sum64 = function (t, e, r, i) {
          var n = t[e],
            o = (i + t[e + 1]) >>> 0;
          (t[e] = ((o < i ? 1 : 0) + r + n) >>> 0), (t[e + 1] = o);
        }),
        (ey.sum64_hi = function (t, e, r, i) {
          return (((e + i) >>> 0 < e ? 1 : 0) + t + r) >>> 0;
        }),
        (ey.sum64_lo = function (t, e, r, i) {
          return (e + i) >>> 0;
        }),
        (ey.sum64_4_hi = function (t, e, r, i, n, o, s, u) {
          var f,
            h = e;
          return (
            (t +
        ...
        (ey.sum64_4_lo = function (t, e, r, i, n, o, s, u) {
          return (e + i + o + u) >>> 0;
        }),
        (ey.sum64_5_hi = function (t, e, r, i, n, o, s, u, f, h) {
          var a,
            l = e;
          return (
            (t +
        ...
        (ey.sum64_5_lo = function (t, e, r, i, n, o, s, u, f, h) {
          return (e + i + o + u + h) >>> 0;
        }),
        (ey.rotr64_hi = function (t, e, r) {
          return ((e << (32 - r)) | (t >>> r)) >>> 0;
        }),
        (ey.rotr64_lo = function (t, e, r) {
          return ((t << (32 - r)) | (e >>> r)) >>> 0;
        }),
        (ey.shr64_hi = function (t, e, r) {
          return t >>> r;
        }),
        (ey.shr64_lo = function (t, e, r) {
          return ((t << (32 - r)) | (e >>> r)) >>> 0;
        });
      var eN = {};
      function eB() {
      ...
      (eN.BlockHash = eB),
        (eB.prototype.update = function (t, e) {
          if (
            ((t = ey.toArray(t, e)),
            this.pending
            ...
            (this.pending = t.slice(t.length - r, t.length)),
              ...
              (t = ey.join32(t, 0, t.length - r, this.endian));
            for (var i = 0; i < t.length; i += this._delta32)
              this._update(t, i, i + this._delta32);
          }
          return this;
        }),
        (eB.prototype.digest = function (t) {
          return (
            this.update(this._pad()), eb(null === this.pending), this._digest(t)
          );
        }),
        (eB.prototype._pad = function () {
      ...
      (eC.ft_1 = function (t, e, r, i) {
        ...
        (eC.ch32 = function (t, e, r) {
          return (t & e) ^ (~t & r);
        }),
        (eC.maj32 = eO),
        (eC.p32 = function (t, e, r) {
          return t ^ e ^ r;
        }),
        (eC.s0_256 = function (t) {
          return e_(t, 2) ^ e_(t, 13) ^ e_(t, 22);
        }),
        (eC.s1_256 = function (t) {
          return e_(t, 6) ^ e_(t, 11) ^ e_(t, 25);
        }),
        (eC.g0_256 = function (t) {
          return e_(t, 7) ^ e_(t, 18) ^ (t >>> 3);
        }),
        (eC.g1_256 = function (t) {
          return e_(t, 17) ^ e_(t, 19) ^ (t >>> 10);
        });
      var eR = ey.rotl32,
        ek = ey.sum32,
        eP = ey.sum32_5,
      ...
      ey.inherits(eF, eD),
        ...
        (eF.prototype._update = function (t, e) {
          ...
          for (; i < r.length; i++)
            r[i] = eR(r[i - 3] ^ r[i - 8] ^ r[i - 14] ^ r[i - 16], 1);
          var n = this.h[0],
            o = this.h[1],
            s = this.h[2],
            u = this.h[3],
          ...
          for (i = 0; i < r.length; i++) {
            var h = ~~(i / 20),
              a = eP(eR(n, 5), eU(h, o, s, u), f, r[i], eT[h]);
            (f = u), (u = s), (s = eR(o, 30)), (o = n), (n = a);
          }
          (this.h[0] = ek(this.h[0], n)),
            (this.h[1] = ek(this.h[1], o)),
            (this.h[2] = ek(this.h[2], s)),
            (this.h[3] = ek(this.h[3], u)),
            (this.h[4] = ek(this.h[4], f));
        }),
        (eF.prototype._digest = function (t) {
          return "hex" === t
            ? ey.toHex32(this.h, "big")
            : ey.split32(this.h, "big");
        });
      var eL = ey.sum32,
        eq = ey.sum32_4,
        ez = ey.sum32_5,
      ...
      function eX() {
        if (!(this instanceof eX)) return new eX();
        eW.call(this),
          (this.h = [
      ...
      ey.inherits(eW, eY),
        ...
        (eW.hmacStrength = 192),
        (eW.padLength = 64),
        (eW.prototype._update = function (t, e) {
          for (var r = this.W, i = 0; i < 16; i++) r[i] = t[e + i];
          for (; i < r.length; i++)
            r[i] = eq(eG(r[i - 2]), r[i - 7], eJ(r[i - 15]), r[i - 16]);
          var n = this.h[0],
            o = this.h[1],
            s = this.h[2],
            u = this.h[3],
            ...
            a = this.h[6],
            l = this.h[7];
          for (eb(this.k.length === r.length), i = 0; i < r.length; i++) {
            var c = ez(l, eQ(f), ej(f, h, a), this.k[i], r[i]),
              d = eL(eK(n), eH(n, o, s));
            (l = a),
              (a = h),
              (h = f),
          ...
          (this.h[0] = eL(this.h[0], n)),
            (this.h[1] = eL(this.h[1], o)),
            (this.h[2] = eL(this.h[2], s)),
            (this.h[3] = eL(this.h[3], u)),
            (this.h[4] = eL(this.h[4], f)),
            (this.h[5] = eL(this.h[5], h)),
            (this.h[6] = eL(this.h[6], a)),
            (this.h[7] = eL(this.h[7], l));
        }),
        ...
        (eX.hmacStrength = 192),
        (eX.padLength = 64),
        (eX.prototype._digest = function (t) {
          return "hex" === t
            ? ey.toHex32(this.h.slice(0, 7), "big")
            : ey.split32(this.h.slice(0, 7), "big");
        });
      var eZ = ey.rotr64_hi,
        e$ = ey.rotr64_lo,
        e0 = ey.shr64_hi,
      ...
      ey.inherits(re, e9),
        ...
        (re.hmacStrength = 192),
        (re.padLength = 128),
        (re.prototype._prepareBlock = function (t, e) {
          ...
          for (; i < r.length; i += 2) {
            var n = (function (t, e) {
              ...
              o = (function (t, e) {
                var r = e$(t, e, 19) ^ e$(e, t, 29) ^ e1(t, e, 6);
                return r < 0 && (r += 4294967296), r;
              })(r[i - 4], r[i - 3]),
              s = r[i - 14],
              u = r[i - 13],
              ...
              h = (function (t, e) {
                var r = e$(t, e, 1) ^ e$(t, e, 8) ^ e1(t, e, 7);
                return r < 0 && (r += 4294967296), r;
              })(r[i - 30], r[i - 29]),
              a = r[i - 32],
              l = r[i - 31];
            (r[i] = e8(n, o, s, u, f, h, a, l)),
              (r[i + 1] = e4(n, o, s, u, f, h, a, l));
          }
        }),
        (re.prototype._update = function (t, e) {
          ...
          for (var y = 0; y < r.length; y += 2) {
            var b = v,
              ...
              E = (function (t, e) {
                var r = e$(t, e, 14) ^ e$(t, e, 18) ^ e$(e, t, 9);
                return r < 0 && (r += 4294967296), r;
              })(l, c),
              ...
              x = r[y],
              C = r[y + 1],
              _ = e5(b, w, M, E, S, I, N, B, x, C),
              O = e7(b, w, M, E, S, I, N, B, x, C);
            b = (function (t, e) {
            ...
            var R = e3(
                b,
                (w = (function (t, e) {
                  var r = e$(t, e, 28) ^ e$(e, t, 2) ^ e$(e, t, 7);
                  return r < 0 && (r += 4294967296), r;
                })(i, n)),
        ...
        (rr.prototype._digest = function (t) {
          return "hex" === t
            ? ey.toHex32(this.h.slice(0, 12), "big")
            : ey.split32(this.h.slice(0, 12), "big");
        }),
        (ex.sha1 = eF),
        (ex.sha224 = eX),
        (ex.sha256 = eW),
      ...
      ey.inherits(rh, rf),
        ...
        (rh.hmacStrength = 192),
        (rh.padLength = 64),
        (rh.prototype._update = function (t, e) {
          for (
            var r = this.h[0],
              i = this.h[1],
              n = this.h[2],
          ...
          (m = rs(this.h[1], n, a)),
            (this.h[1] = rs(this.h[2], o, l)),
            (this.h[2] = rs(this.h[3], s, u)),
        ...
        (rh.prototype._digest = function (t) {
          return "hex" === t
            ? ey.toHex32(this.h, "little")
            : ey.split32(this.h, "little");
        });
      var rl = [
      ...
      function rm(t, e, r) {
        if (!(this instanceof rm)) return new rm(t, e, r);
        (this.Hash = t),
          (this.blockSize = t.blockSize / 8),
          (this.outSize = t.outSize / 8),
          (this.inner = null),
          (this.outer = null),
          this._init(ey.toArray(e, r));
      }
      function rg(t, e, r) {
        return (
          t(
      ...
      (rm.prototype._init = function (t) {
        t.length > this.blockSize && (t = new this.Hash().update(t).digest()),
          eb(t.length <= this.blockSize);
        ...
        (rm.prototype.update = function (t, e) {
          return this.inner.update(t, e), this;
        }),
        (rm.prototype.digest = function (t) {
        ...
        (eA.hmac = rm),
        (eA.sha1 = eA.sha.sha1),
        (eA.sha256 = eA.sha.sha256),
        (eA.sha224 = eA.sha.sha224),
        (eA.sha384 = eA.sha.sha384),
        (eA.sha512 = eA.sha.sha512),
        (eA.ripemd160 = eA.ripemd.ripemd160);
      var rv = rA;
      function rA(t, e) {
        if (!t) throw Error(e || "Assertion failed");
      }
      rA.equal = function (t, e, r) {
        if (t != e) throw Error(r || "Assertion failed: " + t + " != " + e);
      };
      var ry = rg(function (t, e) {
          function r(t) {
            return 1 === t.length ? "0" + t : t;
          }
          function i(t) {
      ...
      function rS(t, e) {
        (this.type = t),
          (this.p = new tF(e.p, 16)),
          (this.red = e.prime ? tF.red(e.prime) : tF.mont(this.p)),
          (this.zero = new tF(0).toRed(this.red)),
          (this.one = new tF(1).toRed(this.red)),
          (this.two = new tF(2).toRed(this.red)),
          (this.n = e.n && new tF(e.n, 16)),
      ...
      (rS.prototype.point = function () {
        ...
        (rS.prototype._fixedNafMul = function (t, e) {
          rE(t.precomputed);
          var r = t._getDoubles(),
            i = rw(e, 1, this._bitLength),
        ...
        (rS.prototype._wnafMul = function (t, e) {
          var r = 4,
            i = t._getNAFPoints(r);
          r = i.wnd;
          for (
            var n = i.points,
              o = rw(e, r, this._bitLength),
        ...
        (rS.prototype._wnafMulAdd = function (t, e, r, i, n) {
          var o,
            s,
            u,
            f = this._wnafT1,
          ...
          for (o = i - 1; o >= 1; o -= 2) {
            var d = o - 1,
              p = o;
            if (1 !== f[d] || 1 !== f[p]) {
              (a[d] = rw(r[d], f[d], this._bitLength)),
                (a[p] = rw(r[p], f[p], this._bitLength)),
        ...
        (rS.BasePoint = rI),
        (rI.prototype.eq = function () {
          throw Error("Not implemented");
        }),
        (rI.prototype.validate = function () {
          return this.curve.validate(this);
        }),
        (rS.prototype.decodePoint = function (t, e) {
          t = rb.toArray(t, e);
        ...
        (rI.prototype.encodeCompressed = function (t) {
          return this.encode(t, !0);
        }),
        (rI.prototype._encode = function (t) {
        ...
        (rI.prototype.encode = function (t, e) {
          return rb.encode(this._encode(e), t);
        }),
        (rI.prototype.precompute = function (t) {
        ...
        (rI.prototype._hasDoubles = function (t) {
        ...
        (rI.prototype._getDoubles = function (t, e) {
        ...
        (rI.prototype._getNAFPoints = function (t) {
        ...
        (rI.prototype.dblp = function (t) {
          for (var e = this, r = 0; r < t; r++) e = e.dbl();
          return e;
        });
      var rN = rg(function (t) {
          "function" == typeof Object.create
        ...
        rB = rb.assert;
      function rx(t) {
        rS.call(this, "short", t),
          (this.a = new tF(t.a, 16).toRed(this.red)),
          (this.b = new tF(t.b, 16).toRed(this.red)),
      ...
      function rC(t, e, r, i) {
        rS.BasePoint.call(this, t, "affine"),
          null === e && null === r
      ...
      function r_(t, e, r, i) {
        rS.BasePoint.call(this, t, "jacobian"),
      ...
      rN(rx, rS),
        (rx.prototype._getEndomorphism = function (t) {
          if (!(!this.zeroA || !this.g || !this.n || 1 !== this.p.modn(3))) {
            if (t.beta) e = new tF(t.beta, 16).toRed(this.red);
            else {
              var e,
                r,
                i,
            ...
            if (t.lambda) r = new tF(t.lambda, 16);
            else {
              var o = this._getEndoRoots(this.n);
              0 === this.g.mul(o[0]).x.cmp(this.g.x.redMul(e))
                ? (r = o[0])
                : ((r = o[1]),
                  rB(0 === this.g.mul(r).x.cmp(this.g.x.redMul(e))));
            }
            return (
              (i = t.basis
                ? t.basis.map(function (t) {
                    return { a: new tF(t.a, 16), b: new tF(t.b, 16) };
                  })
        ...
        (rx.prototype._getEndoRoots = function (t) {
          var e = t === this.p ? this.red : tF.mont(t),
            r = new tF(2).toRed(e).redInvm(),
            i = r.redNeg(),
            n = new tF(3).toRed(e).redNeg().redSqrt().redMul(r);
        ...
        (rx.prototype.pointFromX = function (t, e) {
          (t = new tF(t, 16)).red || (t = t.toRed(this.red));
          var r = t
              .redSqr()
              .redMul(t)
        ...
        (rC.prototype.getY = function () {
          return this.y.fromRed();
        }),
        (rC.prototype.mul = function (t) {
          return (
            (t = new tF(t, 16)),
            this.isInfinity()
              ? this
        ...
        (rC.prototype.mulAdd = function (t, e, r) {
          var i = [this, e],
            n = [t, r];
        ...
        (rC.prototype.jmulAdd = function (t, e, r) {
          var i = [this, e],
            n = [t, r];
          return this.curve.endo
        ...
        (rx.prototype.jpoint = function (t, e, r) {
          return new r_(this, t, e, r);
        }),
        (r_.prototype.toP = function () {
        ...
        (r_.prototype.neg = function () {
          return this.curve.jpoint(this.x, this.y.redNeg(), this.z);
        }),
        (r_.prototype.add = function (t) {
        ...
        (r_.prototype.mixedAdd = function (t) {
        ...
        (r_.prototype._zeroDbl = function () {
          var t, e, r;
          if (this.zOne) {
            var i = this.x.redSqr(),
              n = this.y.redSqr(),
        ...
        (r_.prototype._threeDbl = function () {
          var t, e, r;
          if (this.zOne) {
            var i = this.x.redSqr(),
              n = this.y.redSqr(),
        ...
        (r_.prototype.mul = function (t, e) {
          return (t = new tF(t, e)), this.curve._wnafMul(this, t);
        }),
        (r_.prototype.eq = function (t) {
        ...
        (r_.prototype.eqXToP = function (t) {
          var e = this.z.redSqr(),
        ...
        (r_.prototype.isInfinity = function () {
          return 0 === this.z.cmpn(0);
        });
      var rO = rg(function (t, e) {
          (e.base = rS), (e.short = rx), (e.mont = null), (e.edwards = null);
        }),
        rR = rg(function (t, e) {
          var r,
            i = rb.assert;
      ...
      function rk(t) {
        if (!(this instanceof rk)) return new rk(t);
        (this.hash = t.hash),
          ...
          (this.K = null),
          (this.V = null);
        var e = ry.toArray(t.entropy, t.entropyEnc || "hex"),
          r = ry.toArray(t.nonce, t.nonceEnc || "hex"),
          i = ry.toArray(t.pers, t.persEnc || "hex");
        rv(
      ...
      (rk.prototype._init = function (t, e, r) {
        ...
        (rk.prototype._hmac = function () {
          return new eA.hmac(this.hash, this.K);
        }),
        (rk.prototype._update = function (t) {
        ...
        (rk.prototype.reseed = function (t, e, r, i) {
        ...
        (rk.prototype.generate = function (t, e, r, i) {
          if (this._reseed > this.reseedInterval)
            throw Error("Reseed is required");
          "string" != typeof e && ((i = r), (r = e), (e = null)),
            r && ((r = ry.toArray(r, i || "hex")), this._update(r));
          for (var n = []; n.length < t; )
            (this.V = this._hmac().update(this.V).digest()),
              (n = n.concat(this.V));
          var o = n.slice(0, t);
          return this._update(r), this._reseed++, ry.encode(o, e);
        });
      var rP = rb.assert;
      function rU(t, e) {
        (this.ec = t),
      ...
      (rU.fromPublic = function (t, e, r) {
        return e instanceof rU ? e : new rU(t, { pub: e, pubEnc: r });
      }),
        (rU.fromPrivate = function (t, e, r) {
          return e instanceof rU ? e : new rU(t, { priv: e, privEnc: r });
        }),
        ...
        (rU.prototype.getPublic = function (t, e) {
          return (
        ...
        (rU.prototype.getPrivate = function (t) {
          return "hex" === t ? this.priv.toString(16, 2) : this.priv;
        }),
        (rU.prototype._importPrivate = function (t, e) {
          (this.priv = new tF(t, e || 16)),
            (this.priv = this.priv.umod(this.ec.curve.n));
        }),
        (rU.prototype._importPublic = function (t, e) {
          if (t.x || t.y) {
            "mont" === this.ec.curve.type
              ? rP(t.x, "Need x coordinate")
              : ("short" === this.ec.curve.type ||
                  "edwards" === this.ec.curve.type) &&
                rP(t.x && t.y, "Need both x and y coordinate"),
              (this.pub = this.ec.curve.point(t.x, t.y));
            return;
          }
          this.pub = this.ec.curve.decodePoint(t, e);
        }),
        (rU.prototype.derive = function (t) {
          return (
            t.validate() || rP(t.validate(), "public point not validated"),
            t.mul(this.priv).getX()
          );
        }),
        (rU.prototype.sign = function (t, e, r) {
          return this.ec.sign(t, this, e, r);
        }),
        (rU.prototype.verify = function (t, e) {
      ...
      function rT(t, e) {
        ...
        this._importDER(t, e) ||
          (rD(t.r && t.s, "Signature without r or s"),
          (this.r = new tF(t.r, 16)),
          (this.s = new tF(t.s, 16)),
      ...
      (rT.prototype._importDER = function (t, e) {
        t = rb.toArray(t, e);
        var r = new rF();
        ...
        (rT.prototype.toDER = function (t) {
          ...
          for (
            ...
            r = r.slice(1);
          var i = [2];
          rz(i, e.length), (i = i.concat(e)).push(2), rz(i, r.length);
          var n = i.concat(r),
            o = [48];
          return rz(o, n.length), (o = o.concat(n)), rb.encode(o, t);
        });
      var rj = function () {
      ...
      function rK(t) {
        ...
        "string" == typeof t &&
          (rH(
            Object.prototype.hasOwnProperty.call(rR, t),
            "Unknown curve " + t
          ),
          (t = rR[t])),
          t instanceof rR.PresetCurve && (t = { curve: t }),
      ...
      (rK.prototype.keyPair = function (t) {
        return new rU(this, t);
      }),
        (rK.prototype.keyFromPrivate = function (t, e) {
          return rU.fromPrivate(this, t, e);
        }),
        (rK.prototype.keyFromPublic = function (t, e) {
          return rU.fromPublic(this, t, e);
        }),
        (rK.prototype.genKeyPair = function (t) {
          t || (t = {});
          for (
            var e = new rk({
                hash: this.hash,
              ...
              r = this.n.byteLength(),
              i = this.n.sub(new tF(2));
            ;

          ) {
            var n = new tF(e.generate(r));
            if (!(n.cmp(i) > 0)) return n.iaddn(1), this.keyFromPrivate(n);
          }
        }),
        (rK.prototype._truncateToN = function (t, e) {
        ...
        (rK.prototype.sign = function (t, e, r, i) {
          "object" == typeof r && ((i = r), (r = null)),
            i || (i = {}),
            (e = this.keyFromPrivate(e, r)),
            (t = this._truncateToN(new tF(t, 16)));
          for (
            var n = this.n.byteLength(),
              ...
              f = this.n.sub(new tF(1)),
              h = 0;
            ;
            h++
          ) {
            var a = i.k ? i.k(h) : new tF(u.generate(this.n.byteLength()));
            if (
                  ...
                  if (0 !== (p = p.umod(this.n)).cmpn(0)) {
                    ...
                    return (
                      i.canonical &&
                        p.cmp(this.nh) > 0 &&
                        ((p = this.n.sub(p)), (m ^= 1)),
                      new rT({ r: d, s: p, recoveryParam: m })
                    );
                  }
                }
              }
        ...
        (rK.prototype.verify = function (t, e, r, i) {
          (t = this._truncateToN(new tF(t, 16))),
            (r = this.keyFromPublic(r, i));
          var n = (e = new rT(e, "hex")).r,
            o = e.s;
          if (
            0 > n.cmpn(1) ||
            n.cmp(this.n) >= 0 ||
        ...
        (rK.prototype.recoverPubKey = function (t, e, r, i) {
          rH((3 & r) === r, "The recovery param is more than two bits"),
            (e = new rT(e, i));
          var n = this.n,
            o = new tF(t),
            s = e.r,
        ...
        (rK.prototype.getKeyRecoveryParam = function (t, e, r, i) {
          if (null !== (e = new rT(e, i)).recoveryParam) return e.recoveryParam;
          for (var n, o = 0; o < 4; o++) {
            try {
      ...
      let rJ = new tM("signing-key/5.7.0"),
        rG = null;
      function rY() {
        return rG || (rG = new rQ("secp256k1")), rG;
      }
      class rV {
        constructor(t) {
          em(this, "curve", "secp256k1"),
            em(this, "privateKey", tO(t)),
            32 !==
              (function (t) {
                if ("string" != typeof t) t = tO(t);
                else if (!tC(t) || t.length % 2) return null;
                return (t.length - 2) / 2;
              })(this.privateKey) &&
          ...
          let e = rY().keyFromPrivate(tx(this.privateKey));
          em(this, "publicKey", "0x" + e.getPublic(!1, "hex")),
            em(this, "compressedPublicKey", "0x" + e.getPublic(!0, "hex")),
            em(this, "_isSigningKey", !0);
        }
        _addPoint(t) {
          let e = rY().keyFromPublic(tx(this.publicKey)),
            r = rY().keyFromPublic(tx(t));
        ...
        signDigest(t) {
          ...
          return tP({
            ...
            r: tk("0x" + i.r.toString(16), 32),
            s: tk("0x" + i.s.toString(16), 32),
          });
        }
        computeSharedSecret(t) {
          let e = rY().keyFromPrivate(tx(this.privateKey)),
            r = rY().keyFromPublic(tx(rW(t)));
          return tk("0x" + e.derive(r.getPublic()).toString(16), 32);
        }
      ...
      function rW(t, e) {
        ...
        if (32 === r.length) {
          let t = new rV(r);
          return e
            ? "0x" + rY().keyFromPrivate(r).getPublic(!0, "hex")
            : t.publicKey;
        }
        return 33 === r.length
          ? e
            ? tO(r)
            : "0x" + rY().keyFromPublic(r).getPublic(!1, "hex")
          : 65 === r.length
          ? e
            ? "0x" + rY().keyFromPublic(r).getPublic(!0, "hex")
            : tO(r)
          : rJ.throwArgumentError(
          ...
          case "eip191":
            ...
            return (
              ...
              (function (t) {
                ...
                if (
                  ("string" != typeof t &&
                    el.throwArgumentError("invalid address", "address", t),
                  ...
                  for (
                    t.substring(2, 4) !==
                      ...
                      el.throwArgumentError("bad icap checksum", "address", t),
                      e = new tq(t.substring(4), 36).toString(16);
                    e.length < 40;

                  )
                    e = "0" + e;
                  e = ec("0x" + e);
                } else el.throwArgumentError("invalid address", "address", t);
                return e;
              })(
                tR(
                  tU(
      ...
      var r$ = Object.defineProperty,
        ...
        r8 = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        r4 = (t, e) => {
          for (var r in e || (e = {})) r3.call(e, r) && r8(t, r, e[r]);
          if (r2) for (var r of r2(e)) r6.call(e, r) && r8(t, r, e[r]);
          return t;
        },
        r5 = (t, e) => r0(t, r1(e));
      let r7 = (t) => t?.split(":"),
      ...
      async function ir(t) {
        let { cacao: e, projectId: r } = t,
          ...
          o = ii(n, n.iss),
          s = ie(n.iss);
        return await rX(s, o, i, r9(n.iss), r);
      }
      let ii = (t, e) => {
...
`)
      ...
      function iw() {
        let t = I.Au();
        return {
          privateKey: (0, N.BB)(t.secretKey, im),
          publicKey: (0, N.BB)(t.publicKey, im),
        };
      }
      function iM() {
      ...
      function iE(t, e) {
        let r = I.gi((0, N.mL)(t, im), (0, N.mL)(e, im), !0),
      ...
      function iB(t) {
        return Number((0, N.BB)(t, ip));
      }
      function ix(t) {
        let e = iN("u" > typeof t.type ? t.type : 0);
        if (iB(e) === iy && typeof t.senderPublicKey > "u")
          throw Error("Missing sender public key for type 1 envelope");
        let r =
            "u" > typeof t.senderPublicKey
              ? (0, N.mL)(t.senderPublicKey, im)
              : void 0,
          i = "u" > typeof t.iv ? (0, N.mL)(t.iv, im) : (0, E.randomBytes)(12);
        return iR({
          type: e,
          sealed: new w.OK((0, N.mL)(t.symKey, im)).seal(
            i,
            (0, N.mL)(t.message, iA)
          ),
          iv: i,
      ...
      function iC(t, e) {
        ...
        return iR({ type: r, sealed: (0, N.mL)(t, iA), iv: i, encoding: e });
      }
      function i_(t) {
        let e = new w.OK((0, N.mL)(t.symKey, im)),
          { sealed: r, iv: i } = ik({
            encoded: t.encoded,
            encoding: t?.encoding,
          }),
      ...
      function iO(t, e) {
        let { sealed: r } = ik({ encoded: t, encoding: e });
        return (0, N.BB)(r, iA);
      }
      function iR(t) {
        let { encoding: e = ig } = t;
      ...
      function iP(t, e) {
        let r = ik({ encoded: t, encoding: e?.encoding });
        return iU({
          type: iB(r.type),
          senderPublicKey:
            "u" > typeof r.senderPublicKey
              ? (0, N.BB)(r.senderPublicKey, im)
              : void 0,
      ...
      var iz = Object.defineProperty,
        ...
        iG = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        iY = (t, e) => {
          for (var r in e || (e = {})) iQ.call(e, r) && iG(t, r, e[r]);
          if (iK) for (var r of iK(e)) iJ.call(e, r) && iG(t, r, e[r]);
          return t;
        },
        iV = (t, e) => ij(t, iH(e));
      function iW(t) {
      ...
      function nt(t, e) {
        return !!(e && i9(t)) || ("string" == typeof t && !!t.trim().length);
      }
      function ne(t, e) {
        return !!(e && i9(t)) || ("number" == typeof t && !isNaN(t));
      }
      function nr(t, e) {
      ...
      function ni(t) {
        return !!(nt(t, !1) && t.includes(":")) && 2 === t.split(":").length;
      }
      function nn(t) {
        if (nt(t, !1))
          try {
      ...
      function nf(t) {
        let e = !0;
        return (
          i5(t) ? t.length && (e = t.every((t) => nt(t, !1))) : (e = !1), e
        );
      }
      function nh(t, e) {
        let r = null;
      ...
      function nv(t) {
        return !(i9(t) || !nt(t.method, !1));
      }
      function nA(t) {
        return !(
          i9(t) ||
          (i9(t.result) && i9(t.error)) ||
          !ne(t.id, !1) ||
          !nt(t.jsonrpc, !1)
        );
      }
      function ny(t) {
        return !(i9(t) || !nt(t.name, !1));
      }
      function nb(t, e) {
        return !(
          !ni(e) ||
      ...
      function nw(t, e, r) {
        return (
          ...
          (function (t, e) {
            ...
            return (
              Object.values(t).forEach((t) => {
                i$(t.accounts).includes(e) && r.push(...t.methods);
              }),
              r
            );
          })(t, e).includes(r)
      ...
      function nM(t, e, r) {
        return (
          ...
          (function (t, e) {
            ...
            return (
              Object.values(t).forEach((t) => {
                i$(t.accounts).includes(e) && r.push(...t.events);
              }),
              r
            );
          })(t, e).includes(r)
      ...
      Approved: ${u.toString()}`
        ...
        Approved: ${n.toString()}`
          ...
          s.forEach((t) => {
            i ||
              (V(n[t].methods, o[t].methods)
                ? V(n[t].events, o[t].events) ||
                  (i = i8(
                    "NON_CONFORMING_NAMESPACES",
